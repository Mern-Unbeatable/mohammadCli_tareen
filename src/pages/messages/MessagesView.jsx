...
import { directChats, groupChats } from '../../data/messages';
...
const MessagesView = () => {
  ...
  }, [displayChat?.id, displayChat?.messages?.length, mobilePanel]);
    ...
    <>
      ...
      >
        <Container className="flex h-full min-h-0 flex-col max-xl:!px-0">
          <div className="flex h-full min-h-0 w-full flex-col overflow-hidden bg-white xl:h-[680px] xl:min-h-0 xl:grid xl:grid-cols-[340px_minmax(0,1fr)] xl:rounded-2xl xl:border xl:border-[#E4E7EC]">
            {/* Sidebar — full-screen list on mobile, fixed column on desktop */}
            <aside
            ...
            {/* Chat panel — fills remaining column on desktop */}
            <section
            ...
            >
                ...
                <div className="flex min-w-0 items-center gap-2.5 sm:gap-3">
                  ...
                  {displayChat.avatar ? (
                    ...
                    <Avatar
                      initials={displayChat.initials}
                      size="md"
                      className={displayChat.avatarClass}
                    />
                  )}
              ...
              <div
                className={`shrink-0 border-t border-[#E4E7EC] bg-white px-3 pt-2.5 sm:px-5 sm:py-4 ${
                  isMobileChat ? 'pb-[max(0.625rem,env(safe-area-inset-bottom))]' : 'pb-3'
                }`}
              >
