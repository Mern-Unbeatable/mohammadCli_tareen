        ...
        >
          ...
          {postType === "news" ? (
            <div className="space-y-4">
              ...
              <UploadZone label="Upload Image" hint="JPEG, PNG — up to 50 MB" />
            </div>
          ) : (
            <div className="space-y-4">
              <div>
              ...
              <div>
                <label htmlFor="documentUrl" className={labelClass}>
                  Document URL<span className="text-pink-light"> *</span>
                </label>
                <input
                  id="documentUrl"
                  type="url"
              ...
              <UploadZone label="Upload Document" hint="PDF, DOC, XLS, PPT — up to 50 MB" />
              <UploadZone label="Upload Image" hint="JPEG, PNG — up to 50 MB" />
            </div>
          )}
